...
- Status: Accepted
- Background: the doc library needs three guarantees — historical versions preserved (archival), fresh/stale marking, tamper resistance — plus bilingual (English/Chinese) documentation. Cross-references: root [AGENTS.md](../../AGENTS.md) (Document Lifecycle / Bilingual Rules), `scripts/check-docs.sh`.
