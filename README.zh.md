...
| 你想做什么 | 去哪里 |
|---|---|
| 新成员/零基础，想理解整套方法 | [docs/ 文档地图](./docs/README.zh.md) → [实施篇](./docs/solution/vibe-coding-harness-plan.zh.md) |
...
英文为权威版本（默认文件名），中文为翻译（`*.zh.md`）。核心入口与两篇主文档提供中文翻译版；内部活文档（决策记录、模板、适配卡、计划）默认仅中文。规则见根目录 [AGENTS.md](./AGENTS.md)。文件名一律 ASCII，禁止中文。
